...
# This is a baby
    def __init__(self, name):
        self.name = name
        print(str("Hello baby " + self.name + "!"))
        self.passes = 0
    def hour_passes(self):
        self.passes = self.passes + 1
        if self.passes == 1:
            print(str("Baby " + self.name + str(" is sleeping.")))
        elif self.passes == 2:
            print(str("Baby " + self.name + str(" is awake. Time for food.")))
        else:
            print(str("Baby ") + self.name + str(" is CRYING uncontrollably! Feed the Baby!"))
    def feed_baby(self):
        self.passes = 0
        print(str("Thank you for feeding baby " + self.name + str(".")))
